...
.cf-prog:hover, .cf-stat-link:hover { transform: translateY(-1px); box-shadow: inset 0 0 0 1px rgb(var(--border)); }
...
.cf-stat-l { font-size: 10px; font-weight: 600; color: rgb(var(--text4)); margin-top: 4px; white-space: nowrap; }

/* ── segmented control ────────────────────────────────── */
.cf-seg {
  display: inline-flex; gap: 2px; padding: 4px;
  background: rgb(var(--border) / 0.55); border-radius: 14px;
}
.cf-seg-btn {
...
.cf-seg-on {
  background: rgb(var(--card)); color: rgb(var(--text));
...
.cf-seg-alt { color: rgb(var(--text4)); }
.cf-seg-alt.cf-seg-on { color: rgb(var(--text)); }
.cf-seg-count {
...
.cf-done {
  ...
  background: rgb(var(--card)); box-shadow: inset 0 0 0 1px currentColor;
}
.cf-due-badge {
...
.cf-act-soft:hover { background: rgb(var(--card)); transform: scale(1.06); box-shadow: inset 0 0 0 1px currentColor; }
