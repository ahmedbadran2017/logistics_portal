/**
 * Handoff demo data — ported verbatim from the Claude Design prototype
 * (design_handoff/logistics/data.jsx). Grounded in live ERPNext values
 * (Sales Order / Pick List / Delivery Note / Shipment / Return Shipment).
 * Morocco-first, MAD, carrier Cathedis. Every ported screen reads from here so
 * mock data stays consistent; production swaps these for live RPC calls.
 */

export const WAREHOUSE = "SoftPark Aïn Sebaâ";
export const CITY = "Casablanca";
export const CARRIER = "Cathedis";
export const CUTOFF = "14:00";
export const TODAY = "2026-06-20";

export const ZONES = [
  "FAST ZONE - JM", "SLOW ZONE - JM", "Accessory Zone - JM",
  "Cosmetic zone - JM", "MU Zone - JM", "Textile Zone - JM",
];

export function fmtMAD(n) {
...
export const byId = (id) => TEAM.find((t) => t.id === id) || { name: id, short: id };

// ── Stage + SLA color vocab (Tailwind quads) ────────────────────────────
export const STAGE = {
...
export const SLA_LABEL = { ontrack: "On Track", atrisk: "At Risk", breached: "Breached", late: "Late", returned: "Returned" };
export const STAGE_LABEL = {
  pending: "Pending", picking: "Picking", picked: "Picked", labelgen: "Label Generated",
  label: "Label Printed", shipped: "Shipped", transit: "In Transit", exception: "Exception",
  delivered: "Delivered", returned: "Returned", oos: "Out of Stock", partial: "Partial",
};
...
// ── Today's manifest (Shipment SH-000179, building) + recent ────────────
export const MANIFEST = { no: "SH-000179", parcels: 242, value: 38420, carrier: CARRIER, pickupDate: TODAY, window: "09:00 – 17:00", cutoff: CUTOFF, status: "Draft" };
export const RECENT_MANIFESTS = [
...
export const TRACK_STATES = ["pending", "pickedup", "intransit", "outfordelivery", "delivered", "exception", "failed", "return"];
export const TRACK_LABEL = { pending: "Pending", pickedup: "Picked up", intransit: "In Transit", outfordelivery: "Out For Delivery", delivered: "Delivered", exception: "Exception", failed: "Failed Attempt", return: "Return" };
export const TRACK_COUNTS = { pending: 311, pickedup: 0, intransit: 48, outfordelivery: 218, delivered: 355, exception: 48, failed: 18, return: 16 };
...
export const RETURN_REASONS = { wrong_size: "Wrong size", defective: "Defective", changed_mind: "Changed mind", not_as_described: "Not as described" };
export const RETURN_BY_SKU = [
  { sku: "CSM44021", name: "Sérum éclat 30ml",        count: 18, pct: 34 },
  { sku: "TXT55012", name: "Foulard soie imprimé",    count: 9,  pct: 17 },
  { sku: "MUZ22014", name: "Palette ombres MU",       count: 7,  pct: 13 },
  { sku: "ACC11008", name: "Trousse maquillage zip",  count: 5,  pct: 9 },
  { sku: "MCH100013", name: "Diffuseur huile MCH — box", count: 4, pct: 8 },
];
...
export const SHIPMENTS = [
  { no: "SH-000179", date: TODAY,        parcels: 242, value: 38420, carrier: CARRIER, status: "Draft",     window: "09:00 – 17:00", delivered: 0,   exceptions: 0,  weight: 312, pallets: 4, incoterm: "DAP", service: "Cathedis Express", awb: "—", pickup: "SoftPark Aïn Sebaâ — Dock 1", pickupContact: "Reda ZAARI · +212 661 22 18", deliveryTo: "Cathedis Hub · Casablanca" },
  { no: "SH-000178", date: "2026-06-19", parcels: 287, value: 44310, carrier: CARRIER, status: "Submitted", window: "09:00 – 17:00", delivered: 198, exceptions: 12, weight: 368, pallets: 5, incoterm: "DAP", service: "Cathedis Express", awb: "CTH-MNF-77841", pickup: "SoftPark Aïn Sebaâ — Dock 1", pickupContact: "Reda ZAARI · +212 661 22 18", deliveryTo: "Cathedis Hub · Casablanca" },
  { no: "SH-000177", date: "2026-06-18", parcels: 263, value: 39950, carrier: CARRIER, status: "Submitted", window: "09:00 – 17:00", delivered: 241, exceptions: 9,  weight: 334, pallets: 4, incoterm: "DAP", service: "Cathedis Express", awb: "CTH-MNF-77702", pickup: "SoftPark Aïn Sebaâ — Dock 1", pickupContact: "Reda ZAARI · +212 661 22 18", deliveryTo: "Cathedis Hub · Casablanca" },
  { no: "SH-000176", date: "2026-06-17", parcels: 301, value: 47120, carrier: CARRIER, status: "Booked",    window: "09:00 – 17:00", delivered: 289, exceptions: 7,  weight: 391, pallets: 5, incoterm: "DAP", service: "Cathedis Express", awb: "CTH-MNF-77588", pickup: "SoftPark Aïn Sebaâ — Dock 1", pickupContact: "Reda ZAARI · +212 661 22 18", deliveryTo: "Cathedis Hub · Casablanca" },
];
...
export const STOCK_STATS = { skuCount: 437, totalUnits: 18420, totalValue: 1284500, lowSku: 24, outSku: 4, deadSku: 12, reserved: 612, turnover: 6.4 };
...
// ── Cockpit summary (derived, for the manager hero) ─────────────────────
export const COCKPIT = {
  ordersIn: 328, shipped: 124, printed: 19, toShip: 205,
  beforeCutoff: 143, cutoffPct: 44, pastCutoff: "+07:44:03", cutoff: CUTOFF,
  sameDayPct: 87, sameDayTrend: [82,84,83,85,86,85,87],
  breaches: 2, breachTrend: [4,3,3,2,3,2,2],
  atRisk: 4, atRiskTrend: [2,3,3,4,3,4,4],
  inTransit: 206, transitTrend: [180,190,195,200,203,204,206],
  totalOrders: 1301,
};
