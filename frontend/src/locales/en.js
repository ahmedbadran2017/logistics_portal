export default {
  ...
  gi: {
    title: "Goods in",
    intro: "Receive arriving stock: scan every piece, count piles with the stepper, post ONE receipt when the pallet is done.",
    into: "Into",
    ref: "Reference",
    ...
    clearAll: "Clear all",
    postBtn: "Post receipt",
    posting: "Posting…",
    posted: "Receipt posted — stock is in",
    postFail: "Couldn't post the receipt",
    recentTitle: "Recent receipts (7 days)",
    recentEmpty: "No goods-in entries in the last 7 days.",
  },
  mv: {
    title: "Move stock",
