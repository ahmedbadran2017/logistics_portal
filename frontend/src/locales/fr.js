export default {
  ...
  gi: {
    ...
    intro: "Réceptionnez les arrivages : scannez chaque pièce, ajustez les quantités, postez UN reçu à la fin de la palette.",
    into: "Vers",
    ref: "Référence",
    ...
    postBtn: "Poster le reçu",
    posting: "Envoi…",
    posted: "Reçu posté — le stock est entré",
    postFail: "Impossible de poster le reçu",
    recentTitle: "Reçus récents (7 jours)",
    recentEmpty: "Aucune réception ces 7 derniers jours.",
  },
  mv: {
